...
export function AnimatedBrandMark({ className }: AnimatedBrandMarkProps) {
  return (
    ...
    >
      ...
      <div className="inc-not-found-brand relative z-[1] flex flex-col items-center gap-4 rounded-[22px] border border-white/70 bg-white/95 px-8 py-7 shadow-[0_18px_44px_rgba(8,37,56,0.16)] backdrop-blur-sm">
        <Image
        ...
        />
        <span className="whitespace-nowrap text-[22px] font-medium tracking-[-0.042em] text-[#182329]">
